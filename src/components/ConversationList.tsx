...
export default function ConversationList({
  ...
  // message (or nothing is being recorded at all) — starting "new" from
  // there would just be a pointless reconnect.
  ...
  return (
    <aside className="flex w-60 shrink-0 flex-col border-r border-neutral-800 bg-neutral-950">
      ...
      <h2 className="px-4 pb-3 pt-4 text-xs font-medium uppercase tracking-wide text-neutral-500">
        {t("history.title")}
      </h2>
      ...
      <div className="flex-1 overflow-y-auto px-2 pb-4">
        {conversations.length === 0 ? (
          <p className="px-2 text-xs leading-relaxed text-neutral-600">
            {t("history.empty")}
          </p>
        ) : (
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {isRenaming ? (
                        <input
                          ...
                          className="-my-px w-full rounded border border-neutral-600 bg-neutral-900 px-1 py-px text-sm text-neutral-100 outline-none focus:border-neutral-400"
                        />
                      ) : (
                    ...
                    {!isRenaming && (
                      <div className="flex shrink-0 gap-0.5 opacity-0 transition-opacity duration-200 group-focus-within:opacity-100 group-hover:opacity-100">
                        ...
                        <button
                          ...
                          className={`${btn.dangerGhost} px-1.5 py-1 text-xs`}
                        >
                          ✕
                        </button>
                      </div>
